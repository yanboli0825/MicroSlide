...
extern "C" DBINTERFACE_API int ftpConnect(std::string host_ip, std::string port, ftplib* ftp, std::string user,
                                          std::string passwd); // 1, success, 0, connect failed, -1, ftp null
...
extern "C" DBINTERFACE_API int ftpStoreSingle(ftplib* ftp, const std::string local_image_path, std::string ftp_dir,
                                              std::string fname);
