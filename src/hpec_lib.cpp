...
unsigned int ReadDataFromFpga(int hDev, char* buffer, UCHAR& Channel_Api, ULONG& Data_Type, ULONG& nGet, unsigned int wait_ms)
{
	unsigned int ret = read_data_from_fpga(hDev, buffer, (unsigned int&)Channel_Api, (unsigned int&)Data_Type, (unsigned int&)nGet, wait_ms);
...
unsigned int WriteDataToFpga(int hDev,char* buffer,ULONG DataLength_Api,UCHAR Channel_Api,ULONG Data_Type,ULONG& nSend, unsigned int wait_ms)
{
...
#if PRODUCT_HPEC
ULONG StartReadFpgaDDR(int hDev,UCHAR Channel_Api,UCHAR DDRnumber_Api,ULONG DDROffsetAddr_Api,ULONG DDRLength_Api,UCHAR Mode_Api)
{
	return TIME_OUT_FUNC;
...
ULONG CreateFileInStorage(int hDev, char *FileName_Api, ULONGLONG FileSize_Api, ULONG fNumber_Api, ULONG fChannel_Api, ULONG WaitTime)
{
	return TIME_OUT_FUNC;
}
...
ULONG StartFileTransfer(int hDev, char *FileName_Api, char* buf, ULONGLONG &nRead, ULONGLONG FileOffset_Api, ULONGLONG FileGetSize_Api, ULONG WaitTime)
{
	return TIME_OUT_FUNC;
}
