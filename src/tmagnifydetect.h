...
private:
    ...
    std::map<int, Color> colors = {
        ...
        {1,
         {"4", cv::Scalar(327, 104 * 1.0 / 255, 100 * 1.0 / 255), cv::Scalar(360, 255 * 1.0 / 255, 255 * 1.0 / 255)}},
        ...
        {4,
         {"40", cv::Scalar(173, 153 * 1.0 / 255, 106 * 1.0 / 255), cv::Scalar(254, 255 * 1.0 / 255, 197 * 1.0 / 255)}}};
    int m_slice;             // 分成几份
