...
struct BestImage {
    ...
    unsigned int image_num;                 // 帧号
    unsigned int total_image_count;         // 总图片数
     ...
     */
    BestImage(QImage _image, QString _time_stamp, unsigned int _image_num, unsigned int _total_image_count, unsigned int _sharpness, unsigned int _similarity, unsigned int _effective_area, 
